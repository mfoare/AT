...
if test $# -ne 13; then 
	...
	echo "ex : ./at-inp.sh  at-u0-v1-inpainting-couleur  ./inp/u0-v1/  t  ./Images/triple-color.ppm './mask/mask-disque-t.pgm ./mask/mask-scribble-t.pgm ./mask/mask-text.pgm'   0.1  1.0  0.1  0.1  0.0005  1.1  1.0  0.25"
else
